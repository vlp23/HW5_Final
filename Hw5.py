...
class SetOfGames:
    def __init__(self, prob_head, n_games):
        ...
        for n in range(n_games):
            ...
            self._CountTotalLoss.append(game.get_reward())
            self._CountTotalWin.append(game.get_reward())
    ...
    def outcomes(self):
        if sum(self._gameRewards) < 0:
            self._CountTotalLoss += 1
        else:
            self._CountTotalWin += 1
